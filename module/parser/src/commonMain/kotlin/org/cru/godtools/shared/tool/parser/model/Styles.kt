...
interface Styles : Base {
    ...
    // region Card styles
    val cardBackgroundColor: Color get() = stylesParent.cardBackgroundColor
...
// region Card styles
val Styles?.cardBackgroundColor get() = this?.cardBackgroundColor ?: Manifest.DEFAULT_BACKGROUND_COLOR
// endregion Card styles
