...
import org.cru.godtools.shared.renderer.generated.resources.lesson_accessibility_page_next
import org.cru.godtools.shared.renderer.generated.resources.lesson_accessibility_page_previous
...
class RenderLessonPageTest : BaseRendererTest() {
    ...
    private val previousPage by lazy { runBlocking { getString(Res.string.lesson_accessibility_page_previous) } }
    private val nextPage by lazy { runBlocking { getString(Res.string.lesson_accessibility_page_next) } }
