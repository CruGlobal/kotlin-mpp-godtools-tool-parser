...
import org.cru.godtools.shared.renderer.generated.resources.ic_tool_missing
...
@Composable
internal fun ToolNotFound(modifier: Modifier = Modifier) {
    CompositionLocalProvider(
        ...
        Column(
            ...
            Icon(
                painterResource(Res.drawable.ic_tool_missing),
                contentDescription = null,
                modifier = Modifier.size(90.dp),
            )
            Text(
                text = stringResource(Res.string.tool_not_found),
